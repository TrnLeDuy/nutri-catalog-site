            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane {{ App::getLocale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                        @include('page::admin.pages.partials.edit-fields', ['lang' => $locale])
                    </div>
                    <?php endforeach; ?>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class='form-group{{ $errors->has("template") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::select("template", $page_templates, old("template", $page->template), ['class' => "form-control", 'placeholder' => trans('page::pages.form.template')]) !!}
                        {!! $errors->first("template", '<span class="help-block">:message</span>') !!}
                    </div>
                    <hr>
                    @tags('asgardcms/page', $page)
                    <hr>
                    @mediaSingle('page_featured_image', $page)
                </div>
            </div>
        </div>
    </div>
