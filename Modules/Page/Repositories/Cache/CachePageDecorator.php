...
class CachePageDecorator extends BaseCacheDecorator implements PageRepository
{
    ...
    public function getListPage()
    {
        return $this->remember(function () {
            return $this->repository->getListPage();
        });
    }
    ...
    {
        return $this->remember(function () {
            return $this->repository->getListPost();
        });
    }
    /**
    ...
    public function findPageByCategory($notId)
    {
        $this->clearCache();

        return $this->repository->findPageByCategory($notId);
    }
    ...
    public function getRelatePost($postId, $limit)
    {
        ...
        return $this->repository->getRelatePost($postId, $limit);
    }
    ...
    public function getLatestBlogs($numbers)
    {
        ...
        return $this->repository->getLatestBlogs($numbers);
    }
