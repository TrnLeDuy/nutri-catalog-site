...
class MenuPresenter extends Presenter
{
    ...
    {
        // Handle different menu item class types
        if ($item instanceof \Modules\Menu\MenuItem) {
            return $this->renderModulesMenuItem($item);
        }
        
        // Default handler for Nwidart\Menus\MenuItem
        return parent::getChildMenuItems($item);
    }
    
    /**
     * Render menu items for Modules\Menu\MenuItem
     *
     * @param  \Modules\Menu\MenuItem $item
     * @return string
     */
    protected function renderModulesMenuItem($item)
    {
        $results = '';
