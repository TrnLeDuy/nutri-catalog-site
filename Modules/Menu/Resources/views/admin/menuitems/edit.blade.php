                        ...
                        <div class="tab-content">
                            ...
                            @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                ...
                                <div class="tab-pane {{ App::getLocale() == $locale ? 'active' : '' }}"
                                    id="tab_{{ $i }}">
                                    @include('menu::admin.menuitems.partials.edit-trans-fields', [
                                        'lang' => $locale,
                                    ])
                                </div>
                            @endforeach
        ...
        <div class="col-md-3">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="radio">
                        <input type="radio" id="link-post" name="link_type"
                            value="post"{{ $menuItem->link_type === 'post' ? ' checked' : '' }}>
                        <label for="link-post">{{ trans('menu::menu-items.menu-type.post') }}</label>
                    </div>
                    <div class="radio">
