                                ...
                                <template slot-scope="scope">
                                    <div class="pull-right">
                                        <el-button 
                                            ...
                                            type="primary" 
                                            size="small" 
                                            :disabled="isMediaSelected(scope.row.id)"
                                            @click.prevent="insertMedia(scope)"
                                            :style="buttonStyle(scope.row.id)"
                                        >
                                            <template v-if="isMediaSelected(scope.row.id)">
                                                {{ getMediaOrder(scope.row.id) }}
                                            </template>
                                            <template v-else>
                                                {{ trans('media.insert') }}
                                            </template>
...
<script>
    ...
    export default {
        ...
        props: {
            singleModal: { type: Boolean, default: false },
            ...
            queryServer(customProperties) {
                ...
                axios.get(route('api.media.all-vue', { ...properties, ...customProperties }))
                    .then((response) => {
                        ...
                        this.$set(this, 'media', response.data.data);
