...
if (!function_exists('getHomepageCategory')) {
    function getHomepageCategory($numbers)
    {
        return app(CategoryRepository::class)->getHomepageCategory($numbers);
    }
}
...
if (!function_exists('getProductByCategory')) {
    function getProductByCategory($categoryId, $s)
    {
        return app(ProductRepository::class)->getProductByCategory($categoryId, $s);
    }
}

if (!function_exists('getProductHomepageByCategory')) {
    function getProductHomepageByCategory($categoryId, $numbers)
    {
        return app(ProductRepository::class)->getProductHomepageByCategory($categoryId, $numbers);
    }
}
