            ...
            <div class="box-body">
              <el-tabs v-model="activeTab">
                <el-tab-pane v-for="(localeArray, locale) in locales" :key="localeArray.name" :label="localeArray.name"
                  ...
                  <el-form-item :label="trans('products.form.og_description')">
                  ...
                  <el-form-item :label="trans('products.form.sumary')" :class="{
                    ...
                    <component :is="getCurrentEditor()" v-model="product[locale].sumary"
                      :value="product[locale].sumary"></component>
        ...
        <div class="col-md-3">
          <div class="box box-primary">
            <div class="box-body">
              ...
              <el-form-item :label="trans('products.form.is_best_choice')" :class="{
                'el-form-item is-error': form.errors.has('is_best_choice'),
              }">
                <el-switch v-model="product.is_best_choice" active-color="#13ce66" inactive-color="#ff4949">
                </el-switch>
                <div v-if="form.errors.has('is_best_choice')" class="el-form-item__error"
                  v-text="form.errors.first('is_best_choice')"></div>
              </el-form-item>
