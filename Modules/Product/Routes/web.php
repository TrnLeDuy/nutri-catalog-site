...
$router->get('/' . trans('product::products.router.product') . '/' . trans('product::products.router.category') . '/{slug}', ['as' => 'fe.product.product.category', 'uses' => 'PublicController@getProductByCategory']);
